...
public class CollectDaoSQL {
	...
	public static final String GET_ALL = "SELECT collectionID, collectionText, collectionMaterial, collectionStatus, lastUpdateTime FROM emp2 order by collectionID";
	public static final String GET_ONE = "SELECT collectionID, collectionText, collectionMaterial, collectionStatus, lastUpdateTime FROM emp2 where collectionID = ?";
