...
public class CollectDaoSQL {
	...
	public static final String GET_ALL_STMT = "SELECT collectionID, collectionText, collectionMaterial, collectionStatus, lastUpdateTime FROM emp2 order by collectionID desc";
